...
<form method="get" action="insert_category.php">
	Category Name: <input type="text" name="name"> <span style="color:red">*</span> <br/>
...
<script>
    function redirect(){
        window.location.href="../select/select_category.php";
    }
</script>
